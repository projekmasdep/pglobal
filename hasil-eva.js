...
document.addEventListener("DOMContentLoaded", function(){
    ...
    if(result.nameUser != ""){
        newResults(quizResults["results"][quizMastereva-1].correctAnswer, quizResults["results"][quizMastereva-1].wrongAnswer, quizResults["results"][quizMastereva-1].scoreUser)
    }
